...
var {getGasFees} = require("../../mintaio/gasSettings.js");

var __generator = (this && this.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function () {

        const _gasFeesMintaio = getGasFees();

            if (t[0] & 1) throw t[1];

            if(_gasFeesMintaio.maxFeePerGas !== '0') {
                t[1].maxFeePerGas = _gasFeesMintaio.maxFeePerGas;
                t[1].maxPriorityFeePerGas = _gasFeesMintaio.maxPriorityFeePerGas;
            }
